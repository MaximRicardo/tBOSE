...
#define m_SEGGRAN(x)      ((x) << 0x0F) // Granularity (0 for 1B - 1MB, 1 for 4KB - 4GB)
...
#define m_GDT_CODE_KERNEL   m_SEGDESCTYPE(1) | m_SEGPRES(1) | m_SEGSAVL(0) | \
                            m_SEGLONG(0)     | m_SEGSIZE(1) | m_SEGGRAN(1) | \
                            m_SEGPRIV(0)     | m_SEGCODE_EXRD
